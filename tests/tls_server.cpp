...
TEST( Server, Constructor ) {
    ...
    const Address server_address( Host( "127.0.0.1:6666" ), server_context );
            ...
            for ( int i = 0; i < 5; i++ ) {
                ...
                EXPECT_NO_THROW(
                    ...
                    Client client( Address(
                        ...
                        Host( "127.0.0.1:6666" ), client_context
                    ...
                    // Do something.
                    auto result = client.get_server_info();
                    client.get_server_commands();

                    EXPECT_EQ( result["status"], "dev" );
    ...
    EXPECT_NO_THROW(
        ...
        EXPECT_TRUE( client1.is_secure() );
        EXPECT_TRUE( client2.is_secure() );
